...
VALUES
('me', 'section-resume', 'OWNS', 0, 10),
('me', 'section-evidence', 'OWNS', 0, 20),
('me', 'section-interview', 'OWNS', 0, 30),
('me', 'section-blog', 'OWNS', 0, 40),
('section-resume', 'skill-java', 'INCLUDES', 0, 101),
('section-resume', 'skill-spring-boot', 'INCLUDES', 0, 102),
('section-resume', 'skill-redis', 'INCLUDES', 0, 103),
('section-resume', 'skill-mysql', 'INCLUDES', 0, 104),
('section-resume', 'skill-ai', 'INCLUDES', 0, 105),
('section-evidence', 'project-mine-education-system', 'INCLUDES', 0, 201),
('section-evidence', 'project-private-ai-platform', 'INCLUDES', 0, 202),
('section-evidence', 'module-video-learning', 'INCLUDES', 0, 301),
('section-evidence', 'module-cache-sync', 'INCLUDES', 0, 302),
('section-evidence', 'module-agent-workflow', 'INCLUDES', 0, 303),
('section-interview', 'project-mine-education-system', 'INCLUDES', 0, 501),
('section-interview', 'project-private-ai-platform', 'INCLUDES', 0, 502),
('section-blog', 'blog-redis-video-progress-buffer', 'CONTAINS', 0, 401),
('section-blog', 'blog-rag-sqlbot-agent-boundary', 'CONTAINS', 0, 402),
('section-blog', 'blog-portfolio-docker-deploy-notes', 'CONTAINS', 0, 403),
('blog-redis-video-progress-buffer', 'skill-redis', 'EXPLAINS', 0, 601),
('blog-redis-video-progress-buffer', 'skill-mysql', 'EXPLAINS', 0, 602),
('blog-rag-sqlbot-agent-boundary', 'skill-ai', 'EXPLAINS', 0, 603),
('blog-portfolio-docker-deploy-notes', 'skill-spring-boot', 'EXPLAINS', 0, 604),
('project-mine-education-system', 'skill-redis', 'USES', 0, 701),
('project-mine-education-system', 'skill-mysql', 'USES', 0, 702),
('project-private-ai-platform', 'skill-ai', 'USES', 0, 703),
('module-video-learning', 'skill-redis', 'USES', 0, 801),
('module-cache-sync', 'skill-redis', 'USES', 0, 802),
('module-agent-workflow', 'skill-ai', 'USES', 0, 803)
